    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                Emergency contact update successfully!
...
<div class="container">
    ...
    <div class="row ">
        <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal">Edit emergency contact</button>
        </div>
    </div>
    {{-- end edit button --}}
        ...
        <form action="{{ route('emergencyContact.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h1 class="modal-title fs-5" id="editModalLabel">Edit emergency contact</h1>
