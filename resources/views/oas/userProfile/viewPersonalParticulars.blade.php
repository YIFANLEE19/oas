    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="border-bottom">
                <h1 class="fw-bold">My profile - {{ __('personalParticulars.pageTitle') }}</h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                {{ __('personalParticulars.update_success') }}
...
<div class="container">
        ...
        <div class="col-md-8">
            <div class="row g-2">
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.en_name') }}</p>
                    <h5 class="text-capitalize">{{ $user_detail->en_name }}</h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.ch_name') }}</p>
    ...
    <div class="row d-flex flex-row mt-4">
        ...
        <div class="col-md-8">
            <div class="row g-2">
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.race') }}</p>
                    <h5>{{ $applicant_profile->race['name'] }}</h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.religion') }}</p>
                    <h5>{{ $applicant_profile->religion['name'] }}</h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.nationality') }}</p>
    ...
    <div class="row d-flex flex-row mt-4">
        ...
        <div class="col-md-8">
            <div class="row g-2">
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.birth_date') }}(Y-M-D)</p>
                    <h5>{{ $applicant_profile->birth_date }}</h5>
                    <input type="hidden" id="read_birth_date" value="{{ $applicant_profile->birth_date }}">
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.age') }}</p>
                    <h5 id="read_age"></h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.place_of_birth') }}</p>
    ...
    <div class="row d-flex flex-row mt-4">
        ...
        <div class="col-md-8">
            <div class="row g-2">
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.gender') }}</p>
                    <h5>{{ $applicant_profile->gender['name'] }}</h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.marital') }}</p>
    ...
    <div class="row d-flex flex-row mt-4">
        ...
        <div class="col-md-8">
            <div class="row g-2">
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.email_address') }}</p>
                    <h5>{{ $user_detail->email }}</h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.tel_hp') }}</p>
                    <h5>{{ $user_detail->tel_hp }}</h5>
                </div>
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.tel_h') }}</p>
    ...
    <div class="row d-flex flex-row mt-4 mb-4">
        ...
        <div class="col-md-8">
            <div class="row g-2">
                <div class="col-md mb-3">
                    <p class="text-secondary">{{ __('personalParticulars.address') }}</p>
    ...
    <div class="row ">
        <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal">{{ __('personalParticulars.edit_button') }}</button>
        </div>
    </div>
    {{-- end edit button --}}
</div>
        ...
        <form action="{{ route('personalParticulars.update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h1 class="modal-title fs-5" id="editModalLabel">{{ __('personalParticulars.edit_button') }}</h1>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label mb-2" for="changeInput">
                                        {{ __('personalParticulars.ic_checkbox') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check mb-2 mt-2">
                                    ...
                                    <label class="form-check-label" for="sameAbove">
                                        {{ __('personalParticulars.permanent_address_checkbox') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-12">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">{{ __('personalParticulars.close_button') }}</button>
                    <button type="submit" class="btn btn-primary">{{ __('personalParticulars.save_button') }}</button>
                </div>
            </div>
        </form>
    </div>
