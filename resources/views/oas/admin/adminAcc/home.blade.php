                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($user->role['name'] == 'International Student')
                                            <span class="badge bg-secondary px-3 py-2">{{ $user->role['name'] }}</span>
                                        @elseif ($user->role['name'] == 'Superadmin')
                                            <span class="badge bg-success px-3 py-2">{{ $user->role['name'] }}</span>
                                        @elseif ($user->role['name'] == 'AARO')
                                            <span class="badge bg-danger px-3 py-2">{{ $user->role['name'] }}</span>
                                        @elseif ($user->role['name'] == 'AFO')
                                            <span class="badge bg-warning px-3 py-2">{{ $user->role['name'] }}</span>
                                        @elseif ($user->role['name'] == 'ISO')
                                            <span class="badge bg-dark px-3 py-2">{{ $user->role['name'] }}</span>
                                        @elseif ($user->role['name'] == 'SRO')
                                            <span class="badge bg-info px-3 py-2">{{ $user->role['name'] }}</span>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
