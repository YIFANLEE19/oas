...
ALTER TABLE `applicant_status_logs`
  ...
  ADD KEY `applicant_status_logs_application_status_id_foreign` (`application_status_id`);
...
ALTER TABLE `applicant_status_logs`
  ...
  ADD CONSTRAINT `applicant_status_logs_application_status_id_foreign` FOREIGN KEY (`application_status_id`) REFERENCES `application_statuses` (`id`) ON UPDATE CASCADE,
