...
--
-- Table structure for table `cms_applicant_data`
--

CREATE TABLE `cms_applicant_data` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `application_record_id` bigint(20) UNSIGNED NOT NULL,
  `personCode` varchar(191) DEFAULT NULL,
  `tempCode` varchar(191) DEFAULT NULL,
  `studentCode` varchar(191) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(49, '2023_02_15_143303_create_cms_applicant_data_table', 1);
...
(1, 'Superadmin', 3, 1, 'superadmin@email.com', NULL, '$2y$10$v.Vu8Thay4FsuMgqCsHU8OY7/LBAngr522t38EOViqWo9VrcIxNXO', NULL, '2023-01-03 07:16:56', '2023-01-03 07:16:56'),
(2, 'Local Student', 1, 1, 'localstudent@email.com', NULL, '$2y$10$.QcHWlPbZwagZ7uUUEj7seLYT17bmIHpSz5GJl9DJfbl0nUBihPGm', NULL, '2023-01-03 07:35:55', '2023-01-03 07:35:55');
...
--
-- Indexes for table `cms_applicant_data`
--
ALTER TABLE `cms_applicant_data`
  ADD PRIMARY KEY (`id`),
  ADD KEY `cms_applicant_data_user_id_foreign` (`user_id`),
  ADD KEY `cms_applicant_data_application_record_id_foreign` (`application_record_id`);
...
--
-- AUTO_INCREMENT for table `cms_applicant_data`
--
ALTER TABLE `cms_applicant_data`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `cms_applicant_data`
--
ALTER TABLE `cms_applicant_data`
  ADD CONSTRAINT `cms_applicant_data_application_record_id_foreign` FOREIGN KEY (`application_record_id`) REFERENCES `application_records` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `cms_applicant_data_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE;
