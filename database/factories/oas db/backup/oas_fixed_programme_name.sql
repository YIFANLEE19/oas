...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2023 at 01:30 AM
...
-- Database: `my-system`
--
CREATE DATABASE IF NOT EXISTS `my-system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `my-system`;
...
(4, '2022_12_01_111334_create_roles_table', 1),
(5, '2022_12_14_022929_create_student_types_table', 1),
...
CREATE TABLE `roles` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `englsihName` varchar(255) NOT NULL,
...
INSERT INTO `roles` (`id`, `englsihName`, `chineseName`, `status`) VALUES
(1, 'User', '用户', '1'),
(2, 'Superadmin', '管理员', '1');
...
INSERT INTO `student_types` (`id`, `englishName`, `chineseName`, `status`) VALUES
(1, 'Local Student', '本地学生', '1'),
(2, 'International Student', '国际学生', '1'),
(6, 'local student', NULL, '1'),
(7, 'international student', NULL, '1');
...
INSERT INTO `users` (`id`, `name`, `student_type_id`, `role_id`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(2, 'Local Student', 1, 1, 'localstudent@email.com', NULL, '$2y$10$OuCa.OeqmzUIX5mncl/hVORTW1gGxoh8L/3Ft2RWB03ABSnk7dJzG', NULL, '2022-12-13 18:52:48', '2022-12-13 18:52:48'),
(3, 'Superadmin', NULL, 2, 'superadmin@email.com', NULL, '$2y$10$2c6fACqFxaaUjMaQxH9.Yei4xbBFqx925FmvNLDlyQJaVmhBrqHnK', NULL, '2022-12-13 18:55:47', '2022-12-13 18:55:47');
...
ALTER TABLE `users`
  ...
  ADD KEY `users_student_type_id_foreign` (`student_type_id`),
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_student_type_id_foreign` FOREIGN KEY (`student_type_id`) REFERENCES `student_types` (`id`);
--
-- Database: `oas`
--
...
(1, 1, '2023', '2023-01-26 00:28:36', '2023-01-26 00:28:36');
...
('root', '{\"relation_lines\":\"true\",\"angular_direct\":\"direct\",\"snap_to_grid\":\"off\",\"full_screen\":\"off\",\"small_big_all\":\">\"}');
...
('root', '[{\"db\":\"oas\",\"table\":\"programmes\"},{\"db\":\"oas\",\"table\":\"applicant_status_logs\"},{\"db\":\"oas\",\"table\":\"application_statuses\"},{\"db\":\"oas\",\"table\":\"acc_statuses\"},{\"db\":\"oas\",\"table\":\"application_status_logs\"},{\"db\":\"oas\",\"table\":\"academic_records\"},{\"db\":\"oas\",\"table\":\"applicant_profiles\"},{\"db\":\"oas\",\"table\":\"countries\"},{\"db\":\"oas\",\"table\":\"status_of_healths\"},{\"db\":\"oas\",\"table\":\"users\"}]');
...
('root', '2023-01-26 00:25:26', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `stagingoas`
--
CREATE DATABASE IF NOT EXISTS `stagingoas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `stagingoas`;
...
(1, 'No.6, Jalan Pulai 678', 'Taman Pulai UUtama', '81110', 'Skudai', 'Johor', 131),
(2, 'No.6, Jalan Pulai 678', 'Taman Pulai UUtama', '81110', 'Skudai', 'Johor', 131),
(3, 'No.6, Jalan Pulai 678', 'Taman Pulai UUtama', '81110', 'Skudai', 'Johor', 131),
(4, 'No.6, Jalan Pulai 678', 'Taman Pulai UUtama', '81110', 'Skudai', 'Johor', 131),
(5, 'No.6, Jalan Pulai 678', 'Taman Pulai UUtama', '81110', 'Skudai', 'Johor', 131),
(6, 'No.6, Jalan Pulai 678', 'Taman Pulai UUtama', '81110', 'Skudai', 'Johor', 131);
...
(1, '2002-11-19', 'Johor', 1, 1, 1, 131, 3, 1),
(2, '2002-11-19', 'Johor', 1, 1, 1, 131, 3, 5);
...
(1, 1, 'profile_picture_Superadmin_20230104225252man.jpg'),
(2, 2, 'profile_picture_Local Student_20230104230000man.jpg');
...
(1, 1, 1, 4, '2023-01-04 14:50:27', '2023-01-04 14:52:00'),
(2, 2, 2, 4, '2023-01-04 14:57:07', '2023-01-04 15:00:54');
...
(1, 'Housewife', 9, 1, 131, 2),
(2, 'Housewife', 7, 1, 131, 6);
...
(16, '2022_12_19_142855_create_countries_table', 1),
(17, '2022_12_20_074652_create_applicant_profiles_table', 1),
(18, '2022_12_20_075119_create_application_records_table', 1),
(19, '2022_12_20_075334_create_applicant_profile_pictures_table', 1),
(20, '2022_12_20_075550_create_guardian_details_table', 1),
...
(24, '2022_12_20_082427_create_application_statuses_table', 1),
(25, '2022_12_20_082545_create_application_status_logs_table', 1),
(26, '2022_12_22_105839_create_address_types_table', 1),
(27, '2022_12_22_105840_create_addresses_table', 1),
(28, '2022_12_22_105841_create_address_mappings_table', 1);
...
(1, 'Superadmin', NULL, '800808-01-0445', 'superadmin@email.com', '012-3456789', '012-3456789'),
(2, 'Superadmin Mother', NULL, '800808-01-0088', 'superadminMother@email.com', NULL, '012-3456789'),
(3, 'Superadmin ec1', NULL, NULL, NULL, NULL, '012-3456789'),
(4, 'Superadmin ec2', NULL, NULL, NULL, NULL, '012-3456789'),
(5, 'Local Student', '本地学生', '021119-01-0445', 'localstudent@email.com', '012-3456789', '012-3456789'),
(6, 'Local Student Mother', '本地学生他妈', '800808-01-0456', 'localstudentmother@email.com', NULL, '012-3456789'),
(7, 'Local Student EC1', NULL, NULL, NULL, NULL, '012-3456789'),
(8, 'Local Student EC2', NULL, NULL, NULL, NULL, '012-3456789');
...
(17, '2022_12_16_025618_create_student_types_table', 1),
(18, '2022_12_16_025630_create_roles_table', 1),
(19, '2022_12_16_025631_create_users_table', 1),
(20, '2022_12_16_061645_create_role_users_table', 1);
...
INSERT INTO `student_types` (`id`, `type`, `status`) VALUES
(1, 'Local Student', 1),
(2, 'International Student', 1);
...
INSERT INTO `users` (`id`, `name`, `student_type_id`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Superadmin', NULL, 'superadmin@email.com', NULL, '$2y$10$WlN9AccgFqiZ4HujTILibO7e3LKNBkY9dDwe9Xbp9gZEjm7BVQZ4G', NULL, '2022-12-15 23:13:16', '2022-12-15 23:13:16');
...
--
ALTER TABLE `role_users`
  ADD CONSTRAINT `role_users_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `role_users_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE;
